...
def nn_batch_generator(X_data, y_data, batch_size, csr_2d):
...
def classify(features, labels, use_batches, file, m, csr_2d):
    ...
    if m == "lstm":
        ...
        model = resnet.ResnetBuilder.build_resnet_18(input_shape + (1,), nb_classes)
    ...
    if not use_batches:
        ...
        model.fit_generator(nn_batch_generator(X_train, Y_train, batch_size, csr_2d),
                            steps_per_epoch=X_train.shape[0] // batch_size,
                            validation_steps= vsteps,
                            validation_data=nn_batch_generator(X_test, Y_test, batch_size, csr_2d),
                            #workers=2,
